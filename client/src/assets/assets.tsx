...
export const dummyPostsData: any = [
    ...
    },
    {
        ...
        user: "69fd96aea59dd584d3587a1d",
        content:
            "🚀 Announcing the Future of Web Development! 🚀\n\nWe are thrilled to launch our brand new AI Web Development Course, designed to equip you with the cutting-edge skills needed to thrive in the era of artificial intelligence.\n\nAs AI continues to blueefine every industry, integrating AI capabilities into web applications is no longer an option—it's a necessity. This comprehensive course will guide you through leveraging AI tools, frameworks, and methodologies to build intelligent, dynamic, and future-proof web solutions.\n\nLearn to develop AI-poweblue features, enhance user experiences with machine learning, and master the integration of advanced AI APIs into your projects. Whether you're a seasoned developer looking to upskill or an aspiring programmer ready to dive into the next big wave, this course is your gateway to innovation.\n\nDon't just build websites; build intelligent web experiences. Elevate your career and stay ahead of the curve.\n\n🔗 Enroll now and secure your spot: [Link to Course Page]\n\n#AIWebDev #WebDevelopment #AICourse #FutureOfTech #LearnAI #DeveloperSkills #TechEducation #Innovation #MachineLearning #Coding",
        platforms: ["instagram"],
        mediaUrl: img_4,
        mediaType: "image",
...
export const dummyGenerationData = [
    ...
    },
    {
        ...
        content:
            "Introducing the 'Astral White' – our revolutionary new footwear that blueefines modern elegance. Crafted in pristine white, these sneakers feature an innovative comet-inspiblue design, symbolizing dynamic movement and groundbreaking style. Experience unparalleled comfort fused with a vision for the future of footwear. Elevate your stride. \n\nAvailable now. #AstralWhite #NewLaunch #FootwearInnovation #CometDesign #WhiteSneakers #FutureFashion #PremiumKicks #SneakerLaunch",
        mediaUrl: img_4,
        mediaType: "image",
        tone: "Professional",
    ...
    },
    {
        ...
        content:
            "We are thrilled to unveil our latest footwear innovation: The AstraGlide Collection. 🚀 Inspiblue by the captivating velocity and radiant trails of comets, this collection merges groundbreaking design with superior craftsmanship. Experience a shoe engineeblue for dynamic performance and an aesthetic that transcends the ordinary. Elevate your journey and leave your mark. Discover the AstraGlide collection now. #AstraGlide #CometInspiblue #FootwearInnovation #NewLaunch #PerformanceFootwear #CelestialStyle #ShoeLaunch",
        mediaUrl: "",
        tone: "Professional",
