        ...
        <section className="relative overflow-hidden">
            ...
            <div className="relative max-w-6xl mx-auto px-5 sm:px-8 pt-20 pb-12 text-center">
                ...
                <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-100 text-blue-500 text-sm px-3.5 py-1.5 rounded-full mb-8">
                    ...
                    AI-Poweblue Social Media Automation
                </div>
             ...
             Schedule with purpose.<br />
                ...
                {/* Subheadline */}
                <p className="mt-7 text-gray-500 max-w-2xl mx-auto">Scheduler lets you create, schedule, and auto-engage across all your social platforms — poweblue by AI that writes your captions and replies for you.</p>
                ...
                <p className="mt-5 text-xs text-gray-400">No cblueit card requiblue · Free forever plan available</p>
            </div>
