          ...
          <form className="space-y-5" onSubmit={handleSchedule}>
                ...
                {PLATFORMS.map((p) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-1.5 p-3 rounded-md border transition-all duration-150 ${active ? "bg-blue-50 border-blue-300 text-blue-500 scale-105" : "border-slate-200 text-slate-500 hover:border-slate-300"}`}>
            ...
            <div>
              ...
              {mediaFile ? (
                ...
                <label className="flex items-center justify-center gap-2 p-5 py-10 border-2 border-dashed border-slate-200 rounded-xl cursor-pointer hover:border-blue-300 hover:bg-blue-50/30 transition-all group">
            ...
            <button 
              type="submit" 
              disabled={loading} 
              className="w-full flex items-center justify-center gap-2 py-3.5 bg-blue-500 hover:bg-blue-600 transition-all text-white rounded-lg"
            >
              {loading ? (
                <>
                ...
                <div key={post._id} className="px-5 py-4 hover:bg-slate-50/60 transition-colors">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex gap-1.5 items-center">
                      {post.platforms && post.platforms.map((pl: string) => {
                    ...
                    <div className="flex items-center gap-2">
                      {post.mediaType && (
                        <span className="text-xs bg-slate-100 text-slate-600 border border-slate-200 px-1.5 py-0.5 font-semibold capitalize rounded-md">
                          {post.mediaType}
                        </span>
                      )}
